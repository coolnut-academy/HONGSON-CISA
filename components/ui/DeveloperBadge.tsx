...
export const DeveloperBadge = () => {
    return (
        <div className="flex justify-center items-center py-6 select-none">
            <div className="group relative inline-flex items-center gap-2.5 px-5 py-2 rounded-full 
            ...
            ">
                ...
                {/* Text Content */}
                <div className="flex flex-col sm:flex-row items-baseline sm:gap-1.5 text-xs text-center">
